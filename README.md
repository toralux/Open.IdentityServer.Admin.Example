...
This entire solution was generated with the `dotnet new` template at package version **0.1.7**:
...
The generated projects reference the published `Toralux.Open.IdentityServer.*` 0.1.5 packages — building this solution is the library-consumer test. The only modifications on top of the pristine template output:
