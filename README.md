...
This entire solution was generated with the `dotnet new` template at package version 0.2.2:

```sh
dotnet new install Toralux.Open.IdentityServer.Admin.Templates::0.2.2
...
The generated projects reference the published `Toralux.Open.IdentityServer.*` 0.2.2 packages — building this solution is the library-consumer test. The only modifications on top of the pristine template output:
