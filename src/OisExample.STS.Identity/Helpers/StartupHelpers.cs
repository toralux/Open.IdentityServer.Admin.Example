...
using OisExample.STS.Identity.Configuration;
using OisExample.STS.Identity.Configuration.ApplicationParts;
using OisExample.STS.Identity.Configuration.Constants;
using OisExample.STS.Identity.Configuration.Interfaces;
using Configuration = OisExample.STS.Identity.Configuration;
using OisExample.STS.Identity.Helpers.Localization;
using OisExample.STS.Identity.Services;
